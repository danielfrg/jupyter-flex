...
docs-copy-notebooks:  ## Execute example notebooks into docs output
	...
	cd $(CURDIR)/examples && jupyter-nbconvert illusionist/*.ipynb 		--output-dir=$(CURDIR)/docs/examples/notebooks/illusionist --to=flex-illusionist-nb --execute --ExecutePreprocessor.store_widget_state=True
