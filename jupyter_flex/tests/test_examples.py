...
@pytest.mark.parametrize("nb_name", ["iris-clustering"])
def test_example_nb(voila_server, needle, selenium, base_url, nb_name):
...
#     "custom-css",
# ])
# def test_customize(voila_server, needle, selenium, base_url, nb_name):
...
#     "two-rows",
# ])
# def test_getting_started(voila_server, needle, selenium, base_url, nb_name):
...
#     "section-tabs-rows",
# ])
# def test_layouts(voila_server, needle, selenium, base_url, nb_name):
...
#     "plotly",
# ])
# def test_plots(voila_server, needle, selenium, base_url, nb_name):
...
#     "qgrid",
# ])
# def test_widgets(voila_server, needle, selenium, base_url, nb_name):
