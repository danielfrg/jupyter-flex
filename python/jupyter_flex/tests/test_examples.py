...
def test_example_site(needle, myselenium):
    ...
    needle.assert_screenshot("example_site", threshold=100000)
...
def test_voila(needle, myselenium, base_url, name, path):
    ...
    # Take an element screen diff
    needle.assert_screenshot(f"voila-{name}", threshold=100000)
...
def test_apps(needle, myselenium, base_url, nb_name):
    ...
    # Take an element screen diff
    needle.assert_screenshot(f"{nb_name}", threshold=100000)
...
def test_customize(needle, myselenium, base_url, nb_name):
    ...
    # Take an element screen diff
    needle.assert_screenshot(f"customize/{nb_name}", threshold=100000)
...
def test_getting_started(needle, myselenium, base_url, nb_name):
    ...
    # Take an element screen diff
    needle.assert_screenshot(f"getting-started/{nb_name}", threshold=100000)
...
def test_illusionist(needle, myselenium, base_url, nb_name):
    ...
    # Take an element screen diff
    needle.assert_screenshot(f"illusionist/{nb_name}", threshold=100000)
...
def test_layouts(needle, myselenium, base_url, nb_name):
    ...
    # Take an element screen diff
    needle.assert_screenshot(f"layouts/{nb_name}", threshold=100000)
...
def test_plots(needle, myselenium, base_url, nb_name):
    ...
    # Take an element screen diff
    needle.assert_screenshot(f"plots/{nb_name}", threshold=100000)
...
def test_widgets(needle, myselenium, base_url, nb_name):
    ...
    # Take an element screen diff
    needle.assert_screenshot(f"widgets/{nb_name}", threshold=100000)
