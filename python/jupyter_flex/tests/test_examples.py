...
def test_apps(needle, myselenium, base_url, nb_name):
    ...
    # Take an element screen diff
    needle.assert_screenshot(f"{nb_name}", threshold=300000)
...
def test_customize(needle, myselenium, base_url, nb_name):
    ...
    # Take an element screen diff
    needle.assert_screenshot(f"customize/{nb_name}", threshold=300000)
...
def test_layouts(needle, myselenium, base_url, nb_name):
    ...
    # Take an element screen diff
    needle.assert_screenshot(f"layouts/{nb_name}", threshold=300000)
...
def test_plots(needle, myselenium, base_url, nb_name):
    ...
    # Take an element screen diff
    needle.assert_screenshot(f"plots/{nb_name}", threshold=300000)
...
def test_widgets(needle, myselenium, base_url, nb_name):
    ...
    # Take an element screen diff
    needle.assert_screenshot(f"widgets/{nb_name}", threshold=300000)
